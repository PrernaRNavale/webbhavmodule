...
public class ExcelReader {
	public static final String SAMPLE_XLSX_FILE_PATH = "D:/2018/sample-xlsx-file.xlsx";

	public static void main(String[] args) throws IOException, InvalidFormatException {

		BufferedInputStream bis = new BufferedInputStream(new FileInputStream(SAMPLE_XLSX_FILE_PATH));
